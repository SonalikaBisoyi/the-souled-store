...
'11-12Y','12-14Y','UK3','UK4','UK5','UK6','UK7','UK8'];
  useEffect(() => {
    ...
    const filteredProductsByCollection = selectedCollection === 'ALL'
      ? filteredProductsBySelectedProducts // Display all products when 'ALL' is selected
      : filteredProductsBySelectedProducts.filter((product) => product.collection === selectedCollection);

    // Function to handle sorting
    let sortedProducts = [...filteredProductsByCollection];
    ...
    console.log('Filtered Products:', filteredProductsByCollection);
    setFilteredProducts(sortedProducts);

  }, [selectedProducts, selectedThemes, selectedSizes, selectedPriceRange, sortingOption, selectedCollection, gender]);
  ...
  console.log('Selected Subcategory:', selectedCollection);
  ...
  <AccordionItem>
    {({ isExpanded }) => (
      <>
        ...
        <Link key={product.id} to={`/collections/${product.subcategory}/${product.id}`}>
          <ProductCard
            product={product}
